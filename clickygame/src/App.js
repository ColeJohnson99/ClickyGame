...
let bestScore = 0;
let clickMessage = "Click on a poster to gain points! Don't click on the same one twice or you lose!";
...
class App extends Component {
    ...
    setClicked = id => {
        ...
        // Otherwise, if clicked = false, and the user hasn't finished
            ...
            clickMessage = "Nice! Keep on clicking!";
            ...
            clickMessage = "Well done you have done it! Why not try again?";
            bestScore = 12;
            this.setState({ bestScore });
